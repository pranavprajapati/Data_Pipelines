...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    s3_key="log_data/",
    eparameters="FORMAT AS JSON 's3://udacity-dend/log_json_path.json'"
)
...
stage_songs_to_redshift = StageToRedshiftOperator(
    ...
    s3_bucket='udacity-dend',
    s3_key="song_data",
    eparameters="FORMAT AS JSON 'auto' REGION 'us-west-2' TRUNCATECOLUMNS"
)
